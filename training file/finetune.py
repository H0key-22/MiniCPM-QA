...
class ModelArguments:
    model_name_or_path: Optional[str] = field(default="MiniCPM-2B-sft-fp32")


@dataclass
class DataArguments:
    train_data_path: str = field(
        default="processed_data/Cosmos_train.jsonl",
        metadata={"help": "Path to the training data."},
    )
    eval_data_path: str = field(
        default="processed_data/Cosmos_valid.jsonl",
...
if __name__ == "__main__":
    model_path = "MiniCPM-2B-sft-fp32"
