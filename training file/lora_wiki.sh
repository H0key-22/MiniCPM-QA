...
deepspeed --include localhost:0 finetune.py \
    --model_name_or_path output/WebQA_LoRA/20240711002101/checkpoint-20000 \
    --output_dir output/WebQA_LoRA/$formatted_time/ \
    --train_data_path processed_data/triviaqa-rc_wiki-train.jsonl \
    --eval_data_path processed_data/triviaqa-rc_wiki-ver.jsonl \
